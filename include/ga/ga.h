...
public:
    ...
    virtual vector<Geno*> initializeInitialPopulation()
    {
        // std::vector<Geno*> vec = std::vector<Geno*>();
        //
        // for (int i = 0; i < maxPopulationSize; ++i)
        // {
        //     vec.push_back(new Geno());
        // }
    }
...
// screw this old implementation, i am going to do this better
...
//
//     MutatorFunction<G>* mutatorFunction;
//     SelectorFunction< Ind<G, P>* >* selectorFunction;
//     CrossoverFunction<G>* crossoverFunction;
//
//     int numberOfGenerations;
//     int maxPopulationSize;
